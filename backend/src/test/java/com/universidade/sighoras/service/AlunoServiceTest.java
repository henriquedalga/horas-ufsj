...
public class AlunoServiceTest {
    ...
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext ctx = app.run(args)) {
            ...
            alunoService.criarSolicitacao(matricula2, nome2, "naan.vasconcelos2@gmail.com", "EXTENSAO", pasta2);
            ...
            alunoService.criarSolicitacao(matricula3, nome3, "naan.vasconcelos2@gmail.com", "COMPLEMENTAR", pasta3);
